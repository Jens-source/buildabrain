...
class ParentProfile extends StatefulWidget {
  ...
  @override
  _ParentProfileState createState() =>
...
class _ParentProfileState extends State<ParentProfile>
  ...
  void initChildrenWidgets(childrenLength, height, width) {
    ...
    for (int i = 0; i < childrenLength; i++)
      childrenWidget.add(StreamBuilder<QuerySnapshot>(
                ...
                children: <Widget>[
                          ...
                          child: Center(
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                initialValue:
                                    childrenSnap.documents[i].data['firstName'],
                                onChanged: (value) {
                                  changedName = true;
                                },
                              ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                style: TextStyle(
                                    fontSize: 18, fontFamily: 'Balsamiq'),
                                initialValue:
                                    childrenSnap.documents[i].data['lastName'],
                                onChanged: (value) {
                                  lastName = value;
                                },
                              ),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Text(
                          snapshot.data.documents[0].data['classDay'],
                        ...
                        Text(
                          snapshot.data.documents[0].data['classStartTime'],
                          style: TextStyle(fontSize: 16),
                        ),
                        SizedBox(
                          width: 7,
                        ...
                        Text(
                          snapshot.data.documents[0].data['classEndTime'],
                          style: TextStyle(fontSize: 16),
                        ),
                      ],
                    ),
                  ...
                  snapshot.data.documents.length == 2
                      ? Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(
                                "${snapshot.data.documents[1].data['classDay']}",
                                style: TextStyle(fontSize: 16),
                              ),
                              SizedBox(
                                width: 15,
                              ...
                              Text(
                                "${snapshot.data.documents[1].data['classStartTime']}",
                                style: TextStyle(fontSize: 16),
                              ),
                              SizedBox(
                                width: 7,
  ...
  void initState() {
    ...
    tabController = new TabController(
      length: childrenSnap.documents.length + 1,
      vsync: this,
    );
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius:
                            BorderRadius.all(Radius.elliptical(width, 200))),
                  ),
                ),
                Positioned(
                    left: width / 3.5,
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        width: height / 4,
                        child: CircleAvatar(
                          backgroundImage: tabController.index == 0
                              ? NetworkImage(parent['photoUrl'])
                              : tabController.index == 1
                                  ? NetworkImage(childrenSnap
                                      .documents[0].data['photoUrl'])
                                  : tabController.index == 2
                                      ? NetworkImage(childrenSnap
                                          .documents[1].data['photoUrl'])
                                      : tabController.index == 3
                                          ? NetworkImage(childrenSnap
                                              .documents[2].data['photoUrl'])
                                          : NetworkImage(childrenSnap
                                              .documents[3].data['photoUrl']),
                          child: Container(
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                          ...
                          onPressed: () async {
                            ...
                            filePath =
                                'parentProfile/${user.documents[0].data['uid']}.png';
                            setState(() {
                            ...
                            await Firestore.instance
                                .document(
                                    'users/${user.documents[0].documentID}')
                            ...
                            await Firestore.instance
                                .collection("users")
                                .where("uid",
                                    isEqualTo: user.documents[0].data['uid'])
                                .getDocuments()
                                .then((value) {
                              u = value;
                            });
