  ...
  Future<void> scan() async {
    ...
    await Firestore.instance
      ...
      if (value.documents[0].data['identity'] == "Teacher") {
        ...
        await Firestore.instance
            .collection('users/${value.documents[0].documentID}/timestamps')
            .where('date',
          ...
          if (docs.documents.length == 0) {
            ...
            if (docs.documents[0].data['timeOut'] == null) {
              ...
              await Firestore.instance
                  .collection(
                      'users/${value.documents[0].documentID}/timestamps')
                  .limit(4)
                  .getDocuments()
                            ...
                            return new AlertDialog(
                              ...
                              content: Container(
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                        "What time did you leave the school on ${scanningDocs.documents[i].data['date']}?"),
                                    ListTile(
                                      title: Text(
                                        startTime,
                                ...
                                FlatButton(
                                  ...
                                  onPressed: () async {
                                    if (timeTeaching != null) {
                                      await Firestore.instance
                                          .document(
                                              'users/${value.documents[0].documentID}/timestamps/${scanningDocs.documents[i].documentID}')
                                          .updateData({
                                        "timeOut": startTime,
                    ...
                    return StatefulBuilder(builder: (context, setState) {
                      return new AlertDialog(
                        ...
                        content: AnimatedContainer(
                            ...
                            child: extend == false
                                ? Text(
                                    "Do you want to scan ${value.documents[0].data['firstName']} out?")
                                : Column(
                                    children: [
                                      Text(
                                          "How many hours did ${value.documents[0].data['firstName']} work today?"),
                                      Container(
                                        height: 200,
                                        child: CupertinoTimerPicker(
                                          mode: CupertinoTimerPickerMode.hm,
                          ...
                          FlatButton(
                            ...
                            onPressed: () async {
                              ...
                              if (extend == true && time != null) {
                                await Firestore.instance
                                    .document(
                                        'users/${value.documents[0].documentID}/timestamps/${docs.documents[0].documentID}')
                                    .updateData({
                  ...
                  builder: (context) {
                    return StatefulBuilder(builder: (context, setState) {
                      return new AlertDialog(
                        ...
                        content:
                            Text("This teacher has already scanned in today."),
                        actions: [
                          FlatButton(
                            child: Text(
                              "OK",
