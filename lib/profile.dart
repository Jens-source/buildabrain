                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                ...
                                image: NetworkImage(user.documents[0].data['photoUrl']),
                                fit: BoxFit.cover,
                              ...
                              Navigator.push(context,
                                  MaterialPageRoute(
                                      builder: (BuildContext context) =>
                                          ImageEdit(user.documents[0].data['photoUrl'])));
                            });
                          },
                        ),
                      ),
                  ...
                  Container(
                      ...
                      Center(
                        child: Container(
                          ...
                          child: Text("${user.documents[0].data['firstName']} ${user.documents[0].data['lastName']}", style: TextStyle(
                              fontSize: 30,
                              color: Colors.white
                          ),),
                        ),
            ...
            Container(
              ...
              child: Card(
                ...
                child: ListTile(
                  ...
                  trailing: new IconButton(icon: Icon(Icons.edit),
                      onPressed: (){
                        showDialog(
                            context: context,
                            builder: (BuildContext context) {
                                  ...
                                  FlatButton(
                                    onPressed: ()async {
                                      showDialog(
                                        ...
                                        await UserManagement.updateNumber(number).then((vaewl)async {

                                          FirebaseUser use = await FirebaseAuth.instance.currentUser();
                                          Future.delayed(Duration(milliseconds: 2000)).then((value) {
                                            Firestore.instance.collection('users')
                                                .where('uid', isEqualTo: use.uid)
                                                .getDocuments()
                                                .then((docs) {
                                  ...
                                  builder: (BuildContext context,
                                    ...
                                    return Container(
                                        ...
                                        child: ListView(
                                            children: <Widget>[
                                              ListTile(
                                                title: Text("Change introduction"),
                                              ),
                                              Container(
                                                height: 120,
                                                child: new TextField(
                              ...
                              actions: <Widget>[
                                FlatButton(
                                  onPressed: ()async{
                                    ...
                                    await UserManagement.updateAbout(about).then((vaewl)async {
