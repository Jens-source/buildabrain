...
class EditClass extends StatefulWidget {
  EditClass( this.day, this.teacher, this.startTime, this.endTime,  this.user, this.classType, this.subject, this.docID);
  ...
  @override
  _EditClassState createState() => _EditClassState(this.day, this.teacher, this.startTime, this.endTime,  this.user, this.classType, this.subject, this.docID);
}

class _EditClassState extends State<EditClass> {
  _EditClassState( this.day, this.teacher, this.startTime, this.endTime, this.user, this.classType, this.subject, this.docID);
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  ...
                                  for(int i = 0; i < subjects.length; i++){
                                    ...
                                    await ClassManagement().updateSchedule(day, classType, startFinal, endFinal,
                                        subjects.length == 1 ? sub[0]:
                                        subjects.length == 2 ? "${sub[0]} and ${sub[1]}":
                                        subjects.length == 3 ? "${sub[0]}, ${sub[1]} and  ${sub[2]}": null,
                                ...
                                Container(
                                  ...
                                  child: Center(child: Text("EDIT EVENT", style: TextStyle(
                                      color: Colors.white
                                  ),)),
                                ),
                              ),
