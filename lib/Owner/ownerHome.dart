                  ...
                  await Firestore.instance
                    ...
                    Firestore.instance
                      ...
                      if (val.documents[0].data['minutes'] == 0) {
                        await Firestore.instance
                            .document(
                                'users/${docs.documents[0].documentID}/timestamps/${val.documents[0].documentID}')
                            .updateData({
...
class _Lessons extends State<Lessons> {
  ...
  void initState() {
    ...
    super.initState();
    Firestore.instance.collection('lessons').getDocuments().then((docs) {
