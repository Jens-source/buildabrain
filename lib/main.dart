...
class _MyHomePageState extends State<MyHomePage>
  ...
  Future _neverSatisfied(url) {
    ...
    return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Center(child: Text('My QR code', style: TextStyle(
              color: Colors.orange
          ),),),
  ...
  void initState() {
    setState(() {
      Firestore.instance.collection('users/26UTUC4DV1qusU2lIwrq/timestamps').orderBy("date", descending: true)
          .getDocuments();
    });
          ...
          child: ListView(
            ...
            children: <Widget>[
                  ...
                  items: childrenInfo.map((value) {
                    return DropdownMenuItem(
                      ...
                      new GestureDetector(
                        ...
                        child:
                        new Text(value.data["firstName"], style: TextStyle(
              ...
              ListTile(
                ...
                trailing: Image.asset('lib/Assets/qrcode.png', color: Colors.grey, height: 30, width: 30,),
                onTap: () {
                  Navigator.of(context).pop();
                  _neverSatisfied(teacher.documents[0].data["qrCodeUrl"]);
                },
              ) : Container(),
                    ...
                    flexibleSpace: new FlexibleSpaceBar(
                      ...
                      background: Stack(
                          children: <Widget>[
                            ...
                            Padding(
                                padding: EdgeInsets.only(left: width / 25, top: height / 10),
                            ...
                            Positioned(
                                top: height / 3.2,
                                left: 30,
                                child: identity == "Parent" ?Text(userInfo[0]["firstName"], style: TextStyle(
                                  fontSize: 42,
                  ...
                  SliverList(
                      delegate: SliverChildListDelegate(
                          [
                                            ...
                                            children: <Widget>[
                                              ...
                                              Container(
                                                ...
                                                MaterialButton(
                                                  color: Colors.green,
                                                  onPressed: () {},
                                                  child: Text("Phonics", style: TextStyle(
                                                      fontSize: 20,
                                                      color: Colors.white
                                                  ),),
                            ...
                            Container(
                              padding: EdgeInsets.only(left: 30, top: 30),
                              child: Text("Recent Pictures", style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold
                              ),),
                            ),
