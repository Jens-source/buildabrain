    ...
    Firestore.instance.collection('schedule')
      ...
      for (int i = 0; i < docs.documents.length; i++) {
        if (DateFormat('EEEE').format(
            DateTime.parse(docs.documents[i].data['startDate'])) ==
            'Monday') {
          mon.add(docs.documents[i]);
          maxStudentsMon = maxStudentsMon + docs.documents[i].data['maxStudents'];
        ...
        if (DateFormat('EEEE').format(
          ...
          maxStudentsTue = maxStudentsTue + docs.documents[i].data['maxStudents'];
        ...
        if (DateFormat('EEEE').format(
          ...
          maxStudentsWed = maxStudentsWed + docs.documents[i].data['maxStudents'];
        ...
        if (DateFormat('EEEE').format(
          ...
          maxStudentsThu = maxStudentsThu + docs.documents[i].data['maxStudents'];
        ...
        if (DateFormat('EEEE').format(
          ...
          maxStudentsFri = maxStudentsFri + docs.documents[i].data['maxStudents'];
        ...
        if (DateFormat('EEEE').format(
          ...
          maxStudentsSat = maxStudentsSat + docs.documents[i].data['maxStudents'];
        ...
        if (DateFormat('EEEE').format(
          ...
          maxStudentsSun = maxStudentsSun + docs.documents[i].data['maxStudents'];
      ...
      setState(() {
        print("Finished");
        maxStud = [maxStudentsMon, maxStudentsTue, maxStudentsWed, maxStudentsThu, maxStudentsFri, maxStudentsSat, maxStudentsSun];
        ok = true;
      });
    });
  }
      ...
      body: new ListView.builder(
        ...
        Container(
          ...
          child: new ListTile(
            ...
            trailing: Text("Max: ${maxStud[i]}, Available: ${(maxStud[i] - finStu[i]).toString()}"),
          ),
        )
          )
        );
...
class TimeSlots extends StatefulWidget{
  ...
  @override
  _TimeSlotsState createState() => _TimeSlotsState(this.student, this.weekDay, this.schedules);
}
...
class _TimeSlotsState extends State<TimeSlots> {
                        ...
                        child: ListView(
                          children: <Widget>[
                            ...
                            ListTile(
                              ...
                              title: Text(endDate, style: TextStyle(
                                  color: Colors.grey
                              ),),
                              trailing: IconButton(
                                icon: Icon(Icons.edit),
                            ...
                            ListTile(
                              ...
                              title: Text(endTime, style: TextStyle(
                                  color: Colors.grey
                              ),),
                              trailing: IconButton(
                                icon: Icon(Icons.edit),
                    ...
                    return Container(
                        ...
                        child: ListView(
                          children: <Widget>[
                            ...
                            ListTile(
                              title: Text("Edit Entry", style: TextStyle(
                                  fontSize: 20,
                    ...
                    return Container(
                        ...
                        child: ListView(
                            children: <Widget>[
                              ...
                              ListTile(
                                title: Text(
                                  "Existing Students", style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.bold
                                ),),
                              ),
                              ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, i) {
                                    return new ListTile(
                                      title: Text(
                                          "Name: ${existingStudents[i]
                                              .data['nickName']}"),
                                      subtitle: Text(
                                          "Class: ${existingStudents[i]
                                              .data['classType']}"),
                                        ...
                                        onPressed: () async {
                                          await Firestore.instance.collection(
                                              'schedule/${sched
                                                  .documentID}/students')
                                              .add({
                                            'firstName': existingStudents[i]
                                                .data['nickName'],
                                            'uid': existingStudents[i]
                                                .documentID
                                          });
                                          
                                          
                                          Firestore.instance.document('students/${existingStudents[i].documentID}')
                                          .updateData({
                                            'daysPerWeek': 2,
                                          });

                                          Firestore.instance.collection('students/${existingStudents[i].documentID}/schedules')
                                          .add({
                                            'classEndTime': sched
                                                .data['endTime'],
                                            'classStartTime': sched
                                                .data['startTime'],
                                            'classDay': weekDay,
                  ...
                  return Container(
                      ...
                      child: ListView(
                          children: <Widget>[
                            ...
                            ListTile(
                              title: Text(
                                "Add a new Student", style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold
                              ),),
                            ),
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                FlatButton(
                                  color: gender == false ? Colors.green : Colors
                                      .white,
                                ...
                                FlatButton(
                                  color: gender == false ? Colors.white : Colors
                                      .green,
  ...
  Future scan() async {
    for (int k = 0; k < sorted.length; k++) {
      ...
      await Firestore.instance.collection(
          'schedule/${sorted[k].documentID}/students')
          .getDocuments()
          .then((doc) {
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.pushAndRemoveUntil(context, MaterialPageRoute(
                  builder: (BuildContext context) => OwnerCalendar(student)), (
                  route) => false);
            },
          ),
          actions: <Widget>[
                                    ...
                                    return new ListView(
                                        ...
                                        children: <Widget>[
                                          ...
                                          GestureDetector(
                                            ...
                                            child:
                                            AnimatedContainer(
                                                height: selected[i] ? stu[i] ==
                                                    0 ? 140 : (stu[i].documents
                                                    .length * 33 + 120)
                                                    .toDouble() : 80,
                                                                                                  ...
                                                                                                  return new ListTile(
                                                                                                      ...
                                                                                                      trailing: IconButton(
                                                                                                          ...
                                                                                                          onPressed: () async {
                                                                                                            ...
                                                                                                            await Firestore.instance.collection('schedule')
                                                                                                            .where('timeStamp', isEqualTo: sorted[i]['timeStamp'])
                                                                                                            .getDocuments()
                                                                                                            .then((doc) async {
                                                                                                              Firestore.instance.collection('schedule/${doc.documents[0].documentID}/students')
                                                                                                                  .getDocuments()
                                                                                                                  .then((docs){
                                                                                                                    Firestore.instance.document('schedule/${doc.documents[0].documentID}/students/${docs.documents[0].documentID}')
                                                                                                                      .delete();
                                                                                                              ...
                                                                                                              await Firestore.instance.document('students/${stu[i].documents[j].data['uid']}')
                                                                                                              .get()
                                                                                                              .then((value) => {
                                                                                                                Firestore.instance.document('students/${stu[i].documents[j].data['uid']}')
                                                                                                                    .updateData({
                                                                                                              ...
                                                                                                              await Firestore.instance.collection('students/${stu[i].documents[j].data['uid']}/schedules')
                                                                                                                  .where('classDay', isEqualTo: weekDay)
                                                                                                                  .getDocuments()
                                                                                                              .then((value) async {


                                                                                                                await Firestore.instance.document('students/${stu[i].documents[j].data['uid']}/schedules/${value.documents[0].documentID}')
                                                                                                                    .delete();
                                                                                                              });
                                                                                                            });
