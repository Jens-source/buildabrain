...
class ParentSignup extends StatefulWidget {
  ...
  @override
  _ParentSignupState createState() =>
...
class _ParentSignupState extends State<ParentSignup> {
  ...
  Future<bool> _onBackPressed() async {
    ...
    await Firestore.instance
        ...
        .then((value) {
      Firestore.instance
          .document("users/${value.documents[0].documentID}")
          .delete();
    });
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: picUrl != null
                                  ? NetworkImage(picUrl)
                                  : AssetImage("lib/Assets/defaultPro.jpg"),
                              fit: BoxFit.cover),
                            ...
                            child: Center(
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  initialValue: name,
                                  style: TextStyle(
                                      fontSize: 18, fontFamily: 'Balsamiq'),
                                  onChanged: (value) {
                                    changedName = true;
                                    name = value;
                                  },
                ...
                child: IconButton(
                  onPressed: () async {
                    if (name == null ||
                      ...
                      UserManagement.updateLastName(lastName);
                      UserManagement.updateBirthday(birthday);
                      UserManagement.updateNumber(_number);
                      UserManagement.updateStreet(_street);
                      UserManagement.updateDistrict(_district);
                      UserManagement.updateProvince(_province);
                      if (picUrl == null) {
                        picUrl =
                            "https://t4.ftcdn.net/jpg/00/64/67/63/240_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg";
                      }
                      await UserManagement.updateProfilePicture(picUrl)
                          .then((val) {
                        Navigator.of(context).pop();
  ...
  void initState() {
    ...
    FirebaseAuth.instance.currentUser().then((user) {
      Firestore.instance
          ...
          .then((docs) {
        Firestore.instance
            .collection('users/${docs.documents[0].documentID}/children')
            .getDocuments()
          ...
          if (childDocs.documents.length != 0) {
            for (int i = 0; i < childDocs.documents.length; i++) {
              await Firestore.instance
                  .document(
                      "students/${childDocs.documents[i].data['childId']}")
                  .get()
                  .then((value) {
                setState(() {
                  children.add(value);
                      ...
                      new ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, i) {
                            return new Container(
                              ...
                              child: Card(
                                color: children[i].data['gender'] == "female"
                                    ? Color.fromRGBO(247, 207, 230, 1)
                                    : Color.fromRGBO(205, 244, 218, 1),
                                child: ListTile(
                                    title: Text(
                                        "${children[i].data['firstName'].toString()} ${children[i].data['lastName'].toString()}"),
                                    leading: CircleAvatar(
                                      backgroundImage: NetworkImage(children[i]
                                          .data['photoUrl']
                                          .toString()),
                                    ),
                                    subtitle:
                                        Text(children[i].data['classType']),
                                    trailing: children[i].data['classType'] ==
                                            "preschoolers"
                                        ? Image.asset(
                                            "lib/Assets/preschool.png")
                                        : children[i].data['classType'] ==
                                                "junior"
                                            ? Image.asset(
                                                "lib/Assets/junior.png")
                                            : children[i].data['classType'] ==
                                                    "advanced"
                                                ? Image.asset(
