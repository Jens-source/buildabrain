...
class TeacherSignup extends StatefulWidget {
  TeacherSignup(this.name, this.picUrl);
  final picUrl;

  final name;

  @override
  _TeacherSignupState createState() =>
      _TeacherSignupState(this.name, this.picUrl);
}
                ...
                child: IconButton(
                  onPressed: () async {
                    if (name == null ||
                      ...
                      UserManagement.updateProfilePicture(picUrl);
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                          ...
                          onPressed: () async {
                            ...
                            filePath = 'teacherProfile/${user.uid}.png';
                            setState(() {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (BuildContext context) =>
                                        TeacherSignup(name, downloadUrl)));
                          },
                        )
                      ],
                    ),
