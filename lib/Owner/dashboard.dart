...
class _DashboardState extends State<Dashboard> with TickerProviderStateMixin {
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                "Students ${schedule['studentAmount'].toString()}",
                                style: TextStyle(fontSize: 18),
                              ),
                            )
                          ],
  ...
  void initState() {
    ...
    tabController = new TabController(
        length: 7, vsync: this, initialIndex: initialDateIndex);
    ...
    Firestore.instance
      ...
      for (int i = 0; i < value.documents.length; i++) {
        ...
        if (two.difference(one).inMinutes < 0 &&
        ...
        await Firestore.instance
            .collection("schedule/${value.documents[i].documentID}/students")
            .getDocuments()
            .then((value) {
          ...
          for (int l = 0; l < value.documents.length; l++) {
            ...
            Firestore.instance
                .collection(
                    'students/${value.documents[l].data['uid']}/timestamps')
                .where('date',
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                      child: Container(
                                        ...
                                        width: height / 7,
                                        child: CircleAvatar(
                                            backgroundImage: initialSchedules
                                                        .documents[i]['subject']
                                                        .toString()
                                                        .split(' ')
                                                        .length ==
                                                    3
                                                ? initialSchedules.documents[i]
                                                                ['subject']
                                                            .toString()
                                                            .split(' ')[0] ==
                                                        "IQ"
                                                    ...
                                                    : initialSchedules.documents[i]
                                                        ...
                                                        : initialSchedules
                                                            ...
                                                            : null
                                                : initialSchedules.documents[i]['subject'].toString().split(',')[0] == "IQ"
                                                    ? AssetImage("lib/Assets/iq.png")
                                                    : initialSchedules.documents[i]['subject'].toString().split(',')[0] == "mindmap"
                                                        ? AssetImage("lib/Assets/mindmap.png")
                                                        : initialSchedules.documents[i]['subject'].toString().split(',')[0] == "phonics"
                                                            ? AssetImage("lib/Assets/phonics.png")
                                                            : null,
                                            backgroundColor: initialSchedules.documents[i]['class'] == "preschoolers"
                                                ? Color.fromRGBO(53, 172, 167, 1)
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Container(
                                        child: Text(
                                          "${initialSchedules.documents[i].data['classDay'].toString().substring(0, 3)}"
                                          " ${initialSchedules.documents[i].data['startTime'].toString()} -"
                                          " ${initialSchedules.documents[i].data['endTime'].toString()}",
                                          style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 17),
                                        ),
...
//                                            ),),
                                      ...
                                      Container(
                                        child: Text(
                                          "${initialSchedules.documents[i]['subject'].split(" ")[0]} ${initialSchedules.documents[i]['class'] == "preschoolers" ? "Preschool" : initialSchedules.documents[i]['class'] == "junior" ? "Junior" : initialSchedules.documents[i]['class'] == "advanced" ? "Advanced" : " "}",
                                          style: TextStyle(
                                              fontSize: 22,
                                              color: Colors.white),
                                        ),
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        child: Text(
                                          studentFromSchedule[i].documents ==
                                                  null
                                              ? " "
                                              : studentFromSchedule[i]
                                                  .documents
                                                  .length
                                                  .toString(),
                                          style: TextStyle(fontSize: 20),
