  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: AppBar(
        ...
        title: Text(
            "${schedule['classDay']} \t${schedule['startTime']} - ${schedule['endTime']}"),
        actions: [
          FlatButton(
            child: Text(
              "CANCEL",
        ...
        child: Stack(children: [
          Positioned(
            ...
            child: Container(
              height: 100,
              width: 100,
              child: schedule['class'] == "preschoolers"
              ...
              ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, i) {
                    return Container(
                      ...
                      child: Text(
                        "${i + 1}. \t${studentNameList.documents[i].data['firstName']}",
