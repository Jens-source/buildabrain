...
class _ChildInfoState extends State<ChildInfo> {
  ...
  void initState() {
    ...
    Firestore.instance
        .collection('students/${document.documentID}/schedules')
        .getDocuments()
        .then((value) {
      setState(() {
        classes = value;
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      backgroundColor: document.data['classType'] == "preschoolers"
          ? Color.fromRGBO(23, 142, 137, 1)
          : document.data['classType'] == "junior"
              ? Color.fromRGBO(127, 90, 64, 1)
      ...
      body: Stack(children: <Widget>[
        CustomPaint(
          painter: DrawTriangle(
            document.data['classType'] == "preschoolers"
                ...
                children: <Widget>[
                      ...
                      GestureDetector(
                          onTap: () {
                            Future<DateTime> selectedDate = showDatePicker(
                              ...
                              setState(() {
                                birthday = DateFormat('yyyy-MM-dd').format(val);
                              });
                            });
                          },
                          child: Container(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Text(
                          "${classes.documents[0].data['classDay']}",
                          style: TextStyle(fontSize: 16),
                        ),
                        SizedBox(
                          width: 15,
                        ...
                        Text(
                          "${classes.documents[0].data['classStartTime']}",
                          style: TextStyle(fontSize: 16),
                        ),
                        SizedBox(
                          width: 7,
                        ...
                        Text(
                          "${classes.documents[0].data['classEndTime']}",
                          style: TextStyle(fontSize: 16),
                        ),
                      ],
                    ),
                  ...
                  classes.documents.length == 2
                      ? Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(
                                "${classes.documents[1].data['classDay']}",
                                style: TextStyle(fontSize: 16),
                              ),
                              SizedBox(
                                width: 15,
                              ...
                              Text(
                                "${classes.documents[1].data['classStartTime']}",
                                style: TextStyle(fontSize: 16),
                              ),
                              SizedBox(
                                width: 7,
                              ...
                              Text(
                                "${classes.documents[1].data['classEndTime']}",
                                style: TextStyle(fontSize: 16),
                              ),
                            ],
                          ),
                  ...
                  SizedBox(
                    ...
                    child: ListTile(
                      contentPadding:
                          EdgeInsets.only(right: width / 6, left: 15),
                      title: Text(
                        "Allergies: ",
                        style: TextStyle(
                            fontSize: 20, fontWeight: FontWeight.bold),
                ...
                onPressed: () async {
                  if (firstName == null ||
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (BuildContext context) => MyChild(user)));
                  }
                },
                icon: Icon(
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                          ...
                          onPressed: () async {
                            wait = true;
                            filePath =
                                'childProfile/${document.documentID}.png';
