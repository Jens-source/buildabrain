...
class StudentManagement {
  ...
  Future storeNewStudent( nick, gender, DocumentSnapshot schedule) async {
    ...
    await Firestore.instance
      ...
      await Firestore.instance.collection('schedule/${schedule.documentID}/students')
          .add({
        'firstName': nick,
        'uid': docID,
      });
  ...
  Future removeStudent(studentDocID, schedule, studentUid) async{
    ...
    Firestore.instance.document('schedule/${schedule.documentID}/students/$studentDocID')
        .delete();
    ...
    await Firestore.instance.collection('students/$studentUid/schedules')
    .where('classDay', isEqualTo: schedule.data['classDay'])
    .getDocuments()
    .then((value) {
      Firestore.instance.collection('students/$studentUid/schedules')
